...
if(!$_SESSION['user_id']){
  ...
  if (!isset($_SESSION['order_id'])) {
    $_SESSION['order_id'] = $_POST['order_id']; // Set the default developer_id
}
  if (!isset($_SESSION['user_id'])) {
    $_SESSION['user_id'] = $_POST['user_id']; // Set the default user_id
}

if (!isset($_SESSION['developer_id'])) {
    $_SESSION['developer_id'] = $_POST['developer_id']; // Set the default developer_id
}
?>
<head>
    <meta charset="UTF-8">
...
<input type="checkbox" id="nav-toggle">
    ...
    <div class="main-content">
      ...
      >
      <h4
              class="p-2 text-center rounded mb-4"
              style="background-color: #9260f3; color: white"
            >
            Chat Here
            </h4>
            <h4
              class="p-2 text-center rounded mt-2"
           ...
           Scroll to see chat
            ...
            >
            Refresh after you have done messaging to see messages from other end!
            </h4>
   
            <div class="chat-container">
            <h4 style="padding:10px;">Order Id : <b style="color:red;"><?php echo $_SESSION['order_id']; ?></b></h2>
        <div id="chat-history"></div>
        <form id="message-form">
            <input type="hidden" name="user_id" id="user_id" value="<?php echo $_SESSION['user_id']; ?>">
            <input type="hidden" name="developer_id" id="developer_id" value="<?php echo $_SESSION['developer_id']; ?>">
            <input type="text" id="message-input" placeholder="Type your message...">
            <button style="background-color:#9260f3 !important;color:white;font-weight:bold !important;" type="submit">Send</button>
        </form>
        <button class="mt-2" style="background-color:#9260f3 !important;color:white;font-weight:bold !important;" id="clear-chat">Clear Chat</button>
    </div>
