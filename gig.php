  ...
  >
    ...
    >
      ...
      <div class="input-group mb-4">
        <div class="input-group-prepend">
          <span class="input-group-text" id="inputGroup-sizing-default"
            ><b style="color: #9260f3">Your Gig Name</b
          ></span>
        </div>
        <input
          placeholder="Name"
      ...
      <div class="input-group mb-4">
        <div class="input-group-prepend">
          <span class="input-group-text" id="inputGroup-sizing-default"
            ><b style="color: #9260f3">Price(BDT)</b
          ></span>
        </div>
        <input
      ...
      <div class="input-group mb-4">
          <div class="input-group-prepend">
            <span class="input-group-text" id="inputGroup-sizing-default"
              ><b style="color: #9260f3">Skills</b
            ></span>
          </div>
          <textarea name="skills" placeholder="Your Skills separated by comma" class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
        </div>
        <div class="input-group mb-4">
            <div class="input-group-prepend">
              <span class="input-group-text" id="inputGroup-sizing-default"
                ><b style="color: #9260f3">Features</b
              ></span>
            </div>
            <textarea name="features" placeholder="Your Features in details" class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
          </div>
...
$sql = "SELECT * FROM gig WHERE user_id=".$_SESSION['user_id']." ORDER BY gig_id DESC";
...
?>
    <table style="font-weight: 700;" class="mt-3" width='100%' border=0>
      ...
      echo "<td>".$res['price']." BDT</td>";
      echo "<td>".$res['developer_type']."</td>";
			echo "<td>".$res['skills']."</td>";
			echo "<td>".$res['features']."</td>";		
		}
		?>
	</table>	
  </div>
